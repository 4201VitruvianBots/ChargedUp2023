...
public class VitruvianPPHolonomicDriveController extends PPHolonomicDriveController {
     ...
     */
    public VitruvianPPHolonomicDriveController(PIDController xController, PIDController yController, PIDController rotationController) {
        super(xController, yController, rotationController);
     ...
     */
    public ChassisSpeeds calculate(Pose2d currentPose, PathPlannerTrajectory.PathPlannerState referenceState) {
        double xFF =
