  ...
  public CenterOneBalanceCross(
    ...
    addCommands(
        ...
        new ParallelCommandGroup(
            ...
            (intake, 0.1, vision, swerveDrive).withTimeout(2)),
            new WaitCommand(0.8),
        /** Outakes cone */
        ...
        new ParallelCommandGroup(
            ...
            new SequentialCommandGroup(
                new WaitCommand(5),
                new ParallelCommandGroup(
                    new AutoSetSetpoint(stateHandler, elevator, wrist, frc.robot.Constants.STATE_HANDLER.SETPOINT.INTAKING_LOW_CUBE).withTimeout(0.5),
            ...
            new ParallelCommandGroup(
                ...
                new ParallelCommandGroup(
                    new AutoSetSetpoint(stateHandler,
                    elevator,
                    wrist,
                    frc.robot.Constants.STATE_HANDLER.SETPOINT.STOWED).withTimeout(0.5),
                    new AutoRunIntakeCube(intake, 0.2, vision, swerveDrive).withTimeout(0.5))
                ),
