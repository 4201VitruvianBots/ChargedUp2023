...
public class DriveSideway extends SequentialCommandGroup {
  public DriveSideway(SwerveAutoBuilder autoBuilder, SwerveDrive swerveDrive, FieldSim fieldSim) {

    var trajectory =
        TrajectoryUtils.readTrajectory(
            "DriveSideway", new PathConstraints(Units.feetToMeters(2), Units.feetToMeters(2)));
