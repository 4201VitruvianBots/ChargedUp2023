// package frc.robot.commands.PPLibraries;
...
//           new Translation2d(state.poseMeters.getX(), FIELD_WIDTH_METERS -
...
//   /**
//    * Get a state in the path based on its index. In most cases, using sample() is a better
// method.
//    *
...
//       states.get(i).velocityMetersPerSecond = Math.min(vMax,
// states.get(i).velocityMetersPerSecond);
//     }
...
//           double hypot =
// s1.poseMeters.getTranslation().getDistance(s2.poseMeters.getTranslation());
...
//           state.poseMeters =
//               new Pose2d(state.poseMeters.getTranslation(), state.poseMeters.getRotation());
...
//           GeometryUtil.rotationLerp(poseMeters.getRotation(), endVal.poseMeters.getRotation(),
// t);
