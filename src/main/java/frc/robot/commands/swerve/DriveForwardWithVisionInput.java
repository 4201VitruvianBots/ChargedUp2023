...
public class DriveForwardWithVisionInput extends CommandBase {
    ...
    private final PIDController strafePIDController = new PIDController(Constants.SWERVE_DRIVE.kP_Y,
            Constants.SWERVE_DRIVE.kI_Y,
            Constants.SWERVE_DRIVE.kD_Y);
    ...
    public void execute() {
        ...
        if(m_vision.getValidTarget(Constants.VISION.CAMERA_SERVER.INTAKE))
            strafeOutput = strafePIDController.calculate(m_vision.getTargetXAngle(Constants.VISION.CAMERA_SERVER.INTAKE));
