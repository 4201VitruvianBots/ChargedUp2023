...
public class TestPPSwerveControllerCommand extends PPSwerveControllerCommand {
    ...
    public TestPPSwerveControllerCommand(SwerveDrive swerveDrive, PathPlannerTrajectory trajectory) {
        ...
        m_controller = new PPHolonomicDriveController(swerveDrive.getXPidController(), swerveDrive.getYPidController(), swerveDrive.getThetaPidController());
    ...
    public void execute() {
        ...
        PathPlannerTrajectory.PathPlannerState desiredState = (PathPlannerTrajectory.PathPlannerState) m_trajectory.sample(currentTime);
