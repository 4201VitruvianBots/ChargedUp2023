...
public class SetSwerveOdometry extends CommandBase {
  ...
  public void initialize() {
    ...
    //    LoggingUtils.putNumber("SwerveInitialPositionX", m_pose2d.getX());
    //    LoggingUtils.putNumber("SwerveInitialPositionY", m_pose2d.getY());
    //    LoggingUtils.putNumber("SwerveInitialPositionRotation",
