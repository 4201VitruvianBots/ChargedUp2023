...
/** Keeps a log of how much memory the robot code is using. This is used
 * by the GitHub action MemoryLeakTest to test for memory leaks.
 * Ran by declaring the environment variable --insert-var-name-here on simulation call
 * */
    ...
    * Reference: https://stackoverflow.com/a/74759/13137729 */
    ...
    public void simulationPeriodic() {
        ...
        if (timeSinceLastMemoryLog >= 60000000000L) { // Runs memory log every 60 seconds
            ...
            System.out.println("Amount of memory used by robot code: " + Long.toString(this.usedMemory / 1048576) + " MB");
        ...
        else if (timeSinceLastMemoryLog >= 57000000000L) { // Garbage collects 3 seconds before memory log
            garbageCollect();
        }
        else if (timeSinceLastMemoryLog >= 54000000000L) { // Garbage collects 6 seconds before memory log
            garbageCollect();
        }
    }
}