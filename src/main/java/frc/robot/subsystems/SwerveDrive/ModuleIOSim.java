...
public class ModuleIOSim implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    driveSim.update(Constants.IO.loopPeriodSecs);
    turnSim.update(Constants.IO.loopPeriodSecs);

    double angleDiffRad =
        turnSim.getAngularVelocityRadPerSec() * Constants.IO.loopPeriodSecs;
    ...
    inputs.drivePositionRad = inputs.drivePositionRad
        + (driveSim.getAngularVelocityRadPerSec() * Constants.IO.loopPeriodSecs);
