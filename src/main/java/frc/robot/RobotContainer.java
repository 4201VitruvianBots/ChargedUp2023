...
import frc.robot.commands.auto.DriveFowrardIntakeTest;
...
public class RobotContainer {
  ...
  public void initializeAutoChooser() {
    ...
    // m_autoChooser.addOption("DriveTest", new DriveTest(m_swerveDrive, m_fieldSim));
     m_autoChooser.addOption("DriveFowrardIntakeTest",new DriveFowrardIntakeTest(m_swerveDrive, m_fieldSim, m_intake, null));
