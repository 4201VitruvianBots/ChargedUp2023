...
public class RobotContainer implements AutoCloseable {
    ...
    private final FieldSim m_fieldSim = new FieldSim(m_swerveDrive, m_vision, m_elevator, m_wrist, m_controls);
    ...
    private final StateHandler m_stateHandler = new StateHandler(m_intake, m_wrist, m_swerveDrive, m_fieldSim,
            m_elevator, m_led, m_vision);
        ...
        if (RobotBase.isSimulation()) {
            ...
            testController
                    ...
                    .whileTrue(
                            new ConditionalCommand(
                                    ...
                                    () -> m_stateHandler.getCurrentZone().getZone() == SUPERSTRUCTURE_STATE.ALPHA_ZONE
                                            .getZone()));
                    ...
                    .whileTrue(
                            new ConditionalCommand(
                                    new SetElevatorDesiredSetpoint(
                                            m_elevator, ELEVATOR.SETPOINT.SCORE_LOW_CONE.get(),
                                            testController::getLeftY),
                                    new SetElevatorDesiredSetpoint(
                                            m_elevator, ELEVATOR.SETPOINT.SCORE_LOW_CUBE.get(),
                                            testController::getLeftY),
            ...
            testController
                    ...
                    .whileTrue(
                            new ConditionalCommand(
                                    new SetElevatorDesiredSetpoint(
                                            m_elevator, ELEVATOR.SETPOINT.SCORE_MID_CONE.get(),
                                            testController::getLeftY),
                                    new SetElevatorDesiredSetpoint(
                                            m_elevator, ELEVATOR.SETPOINT.SCORE_MID_CUBE.get(),
                                            testController::getLeftY),
                                    () -> m_intake.getHeldGamepiece() == Constants.INTAKE.HELD_GAMEPIECE.CONE));
            testController
                    .circle()
